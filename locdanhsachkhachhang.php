<?php
$customer_list = array(
    "0" => array("name" => "Lưu Đức Thiên Anh", "date_of_birth" => "1997/01/01", "address" => "HÀ Nội", "image" => "image/img1.jpg"),
    "1" => array("name" => "Phạm Hữu Minh", "date_of_birth" => "1997/10/10", "address" => "Ha Noi", "image" => "image/img1.jpg")
);
